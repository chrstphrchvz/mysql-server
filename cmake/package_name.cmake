...
MACRO(GET_PACKAGE_FILE_NAME Var)
  ...
  IF(NOT SYSTEM_NAME_AND_PROCESSOR)
    ...
    ELSEIF(APPLE)
      ...
      MESSAGE(STATUS "SW_VERS_OUTPUT_LIST: '${SW_VERS_OUTPUT_LIST}'")
      LIST(GET SW_VERS_OUTPUT_LIST 0 SW_VERS_PRODUCTNAME)
      LIST(GET SW_VERS_OUTPUT_LIST 1 SW_VERS_PRODUCTVERSION)
      MESSAGE(STATUS "SW_VERS_PRODUCTNAME: '${SW_VERS_PRODUCTNAME}'")
      MESSAGE(STATUS "SW_VERS_PRODUCTVERSION: '${SW_VERS_PRODUCTVERSION}'")
      ...
      IF(${CMAKE_MATCH_1})
        MESSAGE(STATUS "CMAKE_MATCH_1: TRUE")
      ELSE()
        MESSAGE(STATUS "CMAKE_MATCH_1: FALSE")
      ENDIF()
      IF(${CMAKE_MATCH_2})
        MESSAGE(STATUS "CMAKE_MATCH_2: TRUE")
      ELSE()
        MESSAGE(STATUS "CMAKE_MATCH_2: FALSE")
      ENDIF()
